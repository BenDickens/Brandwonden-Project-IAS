...
mu_TGFB = 15 *_day #decay rate TGFB
mu_FIBRO = 1.0 *_day # Fibroblast death rate (normal)
mu_COLL = 1.5e-5 *_day # Rate of collagen remodelling by fibroblasts

beta_TGFB_M_A = 0.07 *_day # pg/cell
beta_PDGF_M_A = 0.015 *_day # pg/cell
beta_PDGF_FIBRO = 0.0015 *_day
beta_TGFB_FIBRO = 0.004 *_day
beta_FIBRO_COLL = 20 *_day # μg/cell

inverse_max_M_A = 0.002
inverse_max_fibro = 0.0025
inverse_max_coll = 0.0004
growth_FIBRO = 0.924 *_day
...
def collagen_vs_TGFB(x):
    y = 0.0092 * x**3 - 0.1552 * x**2 + 0.6279 * x + 0.2527
    return y
...
def get_params(innate, p0):
    ...
    w = [n_r0, ap_eb0, ap_et0, ap_el0, ap_s0, ap_st0, itmblood0, itmtissue0, m_r0, m_a0, ch0, n_a0, nd_a0, ach0, nd_n0, tgfb0]
    return p, w, predfle
